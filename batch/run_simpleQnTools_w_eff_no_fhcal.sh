...
#SBATCH -t 8:00:00
#SBATCH -J QnToolsEffMpd
#SBATCH -o /lustre/home/user/p/parfenov/TMP/slurm_runQnTools_%A_%a.out
...
export macro_correct=/lustre/home/user/p/parfenov/Soft/qntools_macros/macro/mpd_fixed_target_correct_w_eff_no_fhcal.cc
export macro_correlate=/lustre/home/user/p/parfenov/Soft/qntools_macros/macro/mpd_fixed_target_correlate.cc

echo "${exe_correct} ${macro_correct} $list_dir/$file_list $ecm $nucl_mass $efficiency_file"

# PLAIN
time $exe_correct $macro_correct $list_dir/$file_list $ecm $nucl_mass $efficiency_file
# RECENTERING
time $exe_correct $macro_correct $list_dir/$file_list $ecm $nucl_mass $efficiency_file
# TWIST AND RESCALING
time $exe_correct $macro_correct $list_dir/$file_list $ecm $nucl_mass $efficiency_file
