...
export macro_correct=/lustre/home/user/p/parfenov/Soft/qntools_macros/macro/mpd_fixed_target_correct.cc
...
# PLAIN
time $exe_correct $macro_correct $list_dir/$file_list $ecm $nucl_mass
# RECENTERING
time $exe_correct $macro_correct $list_dir/$file_list $ecm $nucl_mass
# TWIST AND RESCALING
time $exe_correct $macro_correct $list_dir/$file_list $ecm $nucl_mass
